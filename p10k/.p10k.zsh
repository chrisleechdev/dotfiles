# Generated by Powerlevel10k configuration wizard on 2023-11-14 at 16:49 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    privileges              # privileges status from custom_p10k.zsh
